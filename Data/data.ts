export const BaseInfo = {
  ...
  description:
    "Subahan Ali is a Mern Stack Devaloper a background in Computer Science Engineering. specializing in front-end maintenance",
  profilePic: "/images/subahan.jpeg",
};
